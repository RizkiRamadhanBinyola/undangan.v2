...
<head>
    ...
    <meta name="title" content="Undangan Pernikahan Abdurrahman & Ratna Umaya">
    <meta name="description" content="Website Undangan Pernikahan Abdurrahman & Ratna Umaya">
    <link rel="shortcut icon" href="assets/images/favicon.ico">
    <meta name="theme-color" content="#212529">
    <meta name="color-scheme" content="dark">
    <meta property="og:title" content="Undangan Pernikahan Wahyu & Riski">
    <meta property="og:description" content="Website Undangan Pernikahan Abdurrahman & Ratna Umaya">
    <meta property="og:image" content="assets/images/couple.jpg">
...
<body data-email="user@example.com" data-password="12345678" data-url="https://api.ulems.my.id">
            ...
            <div class="text-center pt-4">
                ...
                <div class="py-4">
                    <div class="cropper border border-3 border-light shadow mx-auto">
                        <img src="assets/images/couple.jpg" alt="bg" onclick="modalFoto(this)">
                    </div>
                </div>
                <h1 class="font-estetik my-4" style="font-size: 3rem;">Abdurrahman & Ratna Umaya</h1>
                <h4>Minggu, 27 Agustus 2023</h4>
                <a class="btn btn-outline-light btn-sm shadow rounded-pill px-3 my-2" target="_blank" href="https://calendar.google.com/calendar/event?action=TEMPLATE&tmeid=MzNzdjNlNzNtN2Y1ajJkdnBzNTNnMTRhMm4gcml6a2liaW55b2xhMjVAbQ&tmsrc=rizkibinyola25%40gmail.com">
            ...
            <div class="text-center">
                ...
                <div class="overflow-x-hidden">
                    <div data-aos="fade-right" data-aos-duration="2000">
                        ...
                        <h1 class="font-estetik" style="font-size: 3rem;">Abdurrahman</h1>
                        <h5 class="mt-3 mb-0">Putra ke 1 dari 3 bersaudara</h5>
                        <p class="mb-0">Bapak Rudiyanto & Ibu Erni Yunita</p>
                    </div>
                    ...
                    <div data-aos="fade-left" data-aos-duration="2000">
                        ...
                        <h1 class="font-estetik" style="font-size: 3rem;">Ratna Umaya</h1>
                        <h5 class="mt-3 mb-0">Putri ke 4 dari 3 bersaudara</h5>
                        <p class="mb-0">Bapak Maryadi & Ibu Sudarmi</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <div class="border rounded-pill shadow py-2 px-4 mx-2 mb-4">
                        <div class="row justify-content-center" data-waktu="2023-08-27 00:00:00" id="tampilan-waktu">
                            <div class="col-3 p-1">
                    ...
                    <div class="py-2" data-aos="fade-up" data-aos-duration="1500">
                        <iframe width="100%" height="345" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3958.5642412326756!2d110.759939374999!3d-7.176262792828659!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zN8KwMTAnMzQuNiJTIDExMMKwNDUnNDUuMSJF!5e0!3m2!1sid!2sid!4v1692280941363!5m2!1sid!2sid" data-aos="fade-up" data-aos-duration="1500"></iframe>
                        <br />
                        </iframe>
                        <br>
                        <a href="https://goo.gl/maps/5vLE8vk7xFfKUUE3A" target="_blank" class="btn btn-outline-light btn-sm rounded-pill shadow-sm mb-4 px-5">
                            <i class="fa-solid fa-map-location-dot me-2"></i>Lihat Google Maps
                        </a>
                        <p class="mb-0 mt-1 mx-1 pb-4" style="font-size: 0.9rem;">
                            Dusun gadok Rt 06/07 Kel.sendangharjo
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="wrapper card" style="width: 100%;">
                  <div class="card-body">
                    ...
                    <div class="section-title text-center">
                      <h1 style="font-family: 'Arizonia', Sans-serif;">Kirim Ucapan dan Doa</h1>
                    ...
                    <form id="form">
                        <div class="dbl-field">
                            <div class="field">
                                <input type="text" id="name" placeholder="Masukan nama lengkap anda" required>
                        ...
                        <div class="message">
                            <textarea id="msg" placeholder="Ucapan dan doa anda" required></textarea>
                    ...
                    <hr>
                    <h3 class="mb-3" style="font-family: 'Arizonia', Sans-serif;">Ucapan dan Doa :</h3>
                    ...
                    <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                        <div class="col-auto">
                            <small class="text-light">
                                Build with<i class="fa-solid fa-heart mx-1"></i>azlinvitation.com
                            </small>
                        </div>
                        <div class="col-auto">
                            <small>
                                <img src="assets/images/favicon-16x16.png" alt=""> <a target="_blank" href="https://azlinvitation.com/" class="text-decoration-none">azlinvitation.com</a>
                            </small>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal" id="exampleModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen m-0">
            <div class="modal-content m-0 p-0">
                <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important;">
                    <div class="text-center">
                        <h1 class="font-estetik mb-4" style="font-size: 2.2rem;">Undangan Pernikahan</h1>
                        <div class="cropper border border-3 border-light shadow mb-4 mx-auto">
                            <img src="assets/images/couple.jpg" alt="bg">
                        </div>
                        <h1 class="font-estetik my-4" style="font-size: 2.5rem;">Abdurrahman & Ratna Umaya</h1>
                        <div id="namatamu"></div>
    ...
    <script src="https://code.jquery.com/jquery-3.5.1.min.js"></script>
        ...
        <script>
            function berhasilTerkirim() {
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil terkirim',
                    text: 'Ucapan dan doa berhasil terkirim',
                })
            }
            ...
            function tidakLengkap() {
                Swal.fire({
                    icon: 'error',
                    title: 'Ucapan dan Doa tidak terkirim',
